...
// 
//     This file 'DatabaseCheckAction.cs' is part of KonfDB application - 
...
{
    public abstract class DatabaseCheckAction : BaseStateAction
    {
        ...
        public abstract bool DatabaseExists(Dictionary<string, object> dataDictionary, params object[] data);
    }
}