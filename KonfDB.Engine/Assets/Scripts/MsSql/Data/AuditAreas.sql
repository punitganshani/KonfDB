...
IF NOT EXISTS(SELECT * FROM [Config].[AuditArea] WHERE AuditAreaId=400) INSERT INTO [Config].[AuditArea] VALUES (400, 'Mapping') ELSE UPDATE  [Config].[AuditArea] SET AuditAreaName='Mapping' WHERE AuditAreaId=400
