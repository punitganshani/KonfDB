...
// 
//     This file 'Exit.cs' is part of KonfDB application - 
...
namespace KonfDB.Engine.Commands.Shared
{
    ...
    internal class Exit : ICommand
    {
        ...
        public string Help
        {
            get { return "Exits application"; }
        }

        public CommandOutput OnExecute(CommandInput arguments)
        {
            return new CommandOutput {PostAction = CommandOutput.PostCommandAction.ExitApplication};
        }
