...
// 
//     This file 'DatabaseTableCreateAction.cs' is part of KonfDB application - 
...
{
    public abstract class DatabaseTableCreateAction : BaseStateAction
    {
        ...
        public abstract void CreateTable(string schemaName, string tableName, Dictionary<string, object> dataDictionary,
            object[] data);
    }
}