...
// 
//     This file 'DatabaseSchemaCreateAction.cs' is part of KonfDB application - 
...
{
    public abstract class DatabaseSchemaCreateAction : BaseStateAction
    {
        ...
        public abstract void CreateSchema(string schemaName, Dictionary<string, object> dataDictionary, object[] data);
    }
}