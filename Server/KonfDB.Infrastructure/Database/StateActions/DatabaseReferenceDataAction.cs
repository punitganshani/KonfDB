...
// 
//     This file 'DatabaseReferenceDataAction.cs' is part of KonfDB application - 
...
{
    public abstract class DatabaseReferenceDataAction : BaseStateAction
    {
        ...
        public abstract void RunScripts(Dictionary<string, object> dataDictionary,
            params object[] data);
    }
}