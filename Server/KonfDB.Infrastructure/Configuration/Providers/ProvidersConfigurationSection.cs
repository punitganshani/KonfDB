...
// 
//     This file 'ProvidersConfigurationSection.cs' is part of KonfDB application - 
...
{
    public class ProvidersConfigurationSection : ConfigurationSection
    {
        [ConfigurationProperty("databaseProviders", IsRequired = true)]
        public DatabaseProviderCollection Database
        {
        ...
        public ProviderTypesCollection Types
        {
            get { return (ProviderTypesCollection) base["providerTypes"]; }
        }
    }
}