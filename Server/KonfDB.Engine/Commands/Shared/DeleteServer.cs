...
// 
//     This file 'DeleteServer.cs' is part of KonfDB application - 
...
{
    internal class DeleteServer : IAuthCommand
    {
        public string Keyword
        {
            get { return "DeleteServer"; }
        }

        public string Command
        {
            get { return "DeleteServer /sid:ServerId"; }
        }

        public string Help
        {
            get { return "Deletes Server."; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            var success = CurrentHostContext.Default.Provider.ConfigurationStore.DeleteServer(userId, serverId);
