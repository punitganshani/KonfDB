...
// 
//     This file 'DeleteSuite.cs' is part of KonfDB application - 
...
{
    internal class DeleteSuite : IAuthCommand
    {
        public string Keyword
        {
            get { return "DeleteSuite"; }
        }

        public string Command
        {
            get { return "DeleteSuite /sid:SuiteId"; }
        }

        public string Help
        {
            get { return "Deletes Suite."; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            var success = AppContext.Current.Provider.ConfigurationStore.DeleteSuite(new SuiteModel
            {
                UserId = userId,
                SuiteId = suiteId
            });
