...
// 
//     This file 'GetApp.cs' is part of KonfDB application - 
...
{
    internal class GetApp : IAuthCommand
    {
        private const string DoesNotExist = "Application does not exist";
        ...
        {
            get { return "GetApp { /name:ApplicationName | /id:ApplicationId }"; }
        }

        public string Help
        {
            get { return "Get Application details"; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            {
                model = HostContext.Current.Provider.ConfigurationStore.GetApplication(userId, arguments["name"]);
                completed = true;
            }
            else if (arguments["id"] != null)
            {
                ...
                if (appId != -1)
                {
                    model = HostContext.Current.Provider.ConfigurationStore.GetApplication(userId, appId);
                    completed = true;
                }
            }
