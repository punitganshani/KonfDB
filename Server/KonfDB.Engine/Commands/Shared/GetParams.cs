...
{
    internal class GetParams : IAuthCommand
    {
        ...
        {
            get { return "GetParams /sid:suiteId [/pk:publicKey]"; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            if (suiteId != -1)
            {
                listOfParams = CurrentHostContext.Default.Provider.ConfigurationStore.GetParameters(userId, suiteId);
            }
            else
            {
