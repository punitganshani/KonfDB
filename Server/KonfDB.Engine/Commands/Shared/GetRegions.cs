...
// 
//     This file 'GetRegions.cs' is part of KonfDB application - 
...
{
    internal class GetRegions : IAuthCommand
    {
        ...
        {
            get { return "GetRegions /sid:SuiteId"; }
        }

        public string Help
        {
            get { return "Get Regions in a Suite"; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            var model = HostContext.Current.Provider.ConfigurationStore.GetRegions(userId, suiteId);
