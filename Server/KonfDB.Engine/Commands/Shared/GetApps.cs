...
// 
//     This file 'GetApps.cs' is part of KonfDB application - 
...
{
    internal class GetApps : IAuthCommand
    {
        ...
        {
            get { return "GetApps /sid:SuiteId"; }
        }

        public string Help
        {
            get { return "Get Applications in a Suite"; }
        }
        ...
        public CommandOutput OnExecute(CommandInput arguments)
        {
            ...
            var model = CurrentHostContext.Default.Provider.ConfigurationStore.GetApplications(userId, suiteId);
